 ...
 * 
 * @version $Id: Markdown.php 2933 2007-11-09 20:37:35Z moraes $
 * 
...
require_once 'Markdown/Plugin/Header.php'; 
...
require_once 'Markdown/Plugin/EmStrong.php'; 
require_once 'Markdown/Plugin/Break.php'; 
 
class Solar_Markdown {
