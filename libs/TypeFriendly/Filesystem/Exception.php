...
/**
 * The exception class for TypeFriendly_Filesystem.
 */
class TypeFriendly_Filesystem_Exception extends TypeFriendly_Exception
{

} // end TypeFriendly_Filesystem_Exception;